...
class ENV {
  ...
  static String GOOGLE_ADMOB_DEV_BANNER_IOS =
      dotenv.env['GOOGLE_ADMOB_DEV_BANNER_IOS'] as String;
  static String GOOGLE_ADMOB_DEV_BANNER_AOS =
      dotenv.env['GOOGLE_ADMOB_DEV_BANNER_AOS'] as String;
