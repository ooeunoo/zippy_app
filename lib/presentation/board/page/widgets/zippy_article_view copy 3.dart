        ...
        return Container(
          ...
          child: Theme(
            ...
            child: ExpansionTile(
              ...
              tilePadding: EdgeInsets.all(AppDimens.width(16)),
              trailing: Container(
              ...
              title: Column(
                ...
                children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          gradient: LinearGradient(
                            ...
                            colors: [
                              AppColor.blue500.withOpacity(0.2),
                              AppColor.blue900.withOpacity(0.2),
                            ],
                          ),
                          borderRadius:
                              BorderRadius.circular(AppDimens.radius(10)),
                          border: Border.all(
                            color: AppColor.blue400.withOpacity(0.3),
                            width: 1,
                          ),
                        ),
                        child: Icon(
                  ...
                  Padding(
                    padding: EdgeInsets.only(left: AppDimens.width(46)),
                    child: Row(
                      children: [
                        Icon(
                    ...
                    children: section.content.asMap().entries.map((entry) {
                      ...
                      return Container(
                        margin: EdgeInsets.only(
                          top: index == 0 ? 0 : AppDimens.height(20),
                        ),
                        decoration: BoxDecoration(
                          gradient: LinearGradient(
                            begin: Alignment.topLeft,
